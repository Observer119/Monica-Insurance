  ...
  const getResultStatus = () => {
    ...
    if (score >= 6) {
      return {
        ...
        title: 'Gut abgesichert – Optimierung möglich',
      ...
      return {
        ...
        title: 'Lücken in der Absicherung – Jetzt handeln!',
      ...
      return {
        ...
        title: 'Akuter Handlungsbedarf – Schutz aufbauen!',
    ...
    <>
      <section className="pt-32 pb-16 bg-gray-light">
        <div className="container-custom">
          <h1 className="font-bold mb-4">Versicherungs-Selbstcheck</h1>
